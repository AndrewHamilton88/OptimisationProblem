...
namespace ConsoleApplication1
{
    class RunnerCyclePlan
    {
        ...
        public double RunAlgorithm(int StartingSeeds, int StepsClimbed, int MutationsAroundAPoint, List<double[]> CurrentRoadState)
        {
            //List<double[]> CurrentRoadState = PopulateStages();
            List<int[]> BestCyclePlan = new List<int[]>();
            double LeastDelay = 9999999999;
            
            StreamWriter sw = new StreamWriter("DetailedOutputV4For" + StartingSeeds + "seeds," + StepsClimbed + "steps," + MutationsAroundAPoint + "Mutations.csv");
